...
export class ManageCreditComponent implements OnInit {
  ...
  displayedColumns = ['id', 'customer_name', 'Amount', 'due_date', 'created_at', 'actions'];
 ...
 // dataSource: ExampleDataSource | null;
  ...
  startEdit(i: number, id: number, customer: Customer, Amount: string, due_date: string) {
    this.id = id;
    // index row is used just for debugging proposes and can be removed
    this.index = i;
    console.log(this.index);
    const dialogRef = this.dialog.open(EditCreditComponent, {
      data: {id: id, customer: customer, Amount: Amount, due_date: due_date}
    });
  ...
  getTransactions(): void {
    const transaction_url = transactions + 'CRED';
