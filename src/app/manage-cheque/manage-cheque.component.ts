...
export class ManageChequeComponent implements OnInit {
  ...
  displayedColumns = ['id', 'customer_name', 'cheque_number', 'Amount', 'due_date', 'created_at', 'actions'];
  ...
  constructor(private _dataService: DataService, public httpClient: HttpClient,
  ...
  startEdit(i: number, id: number, customer: Customer, cheque_number: Number, Amount: string, due_date: string) {
    this.id = id;
    // index row is used just for debugging proposes and can be removed
    this.index = i;
    console.log(this.index);
    const dialogRef = this.dialog.open(EditChequeComponent, {
      data: {id: id, customer: customer, cheque_number: cheque_number, Amount: Amount, due_date: due_date}
    });
  ...
  getTransactions(): void {
    const transaction_url = transactions + 'CHEQ';
    this._dataService.get(transaction_url)
        .subscribe(data => {
